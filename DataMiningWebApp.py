...
#Select Location
Select = st.radio("Please select", ( "Introduction", "Data Preprocessing", "EDA","Label Encoding","Feature Selection","Model Construction and Comparison"))
...
elif Select == "Model Construction and Comparison":
    st.header('Model Construction and Comparison')
